...
a5=a4.reshape(3,3)
#print(a5)
a6=np.concatenate([a1,a1],axis=0)#Vertical Concatenate
a7=np.concatenate([a1,a1],axis=1)#Horizontal Concatenate
#print(a6)
#print(a7)
a8=a1[a1>20]
a9=a1.mean()
...
#showing movie rating data (taking from multiple files)
